...
It *is not a payment provider* but simulates communicating with one via the `Simulation` Service.
...
## Business Processes
The payment service is part of the [Buy](/docs/docs/dev-manuals/architecture/business-processes.md#buy-process) and [Return](/docs/docs/dev-manuals/architecture/business-processes.md#return-process) process.
