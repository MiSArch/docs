...
<div className="repository-structure">
 ...
 functions - `user.rs` User with additional GraphQL field(s) provided by this service - `wishlist_connection.rs` GraphQL
 connection of wishlist - `wishlist.rs` Wishlist datatype
</div>
