...
The service provides a REST API which is used by the payment and shipment service, to register about new events to simulate. Additionally, users can query all currently queued events and manually change the status of events.
